...
All slides were generated straight from Markdown using Pandoc and LaTeX Beamer
with the metropolis theme. You can always view the generated slides from the
links above, but if you wish to **compile from source**, you'd need the
